...
def mandarDadosPartida( estatisticasCasa: Estatisticas,estatisticasFora: Estatisticas, partida: Partidas) :
...
def mandarDadosPartidaAnalisada( estatisticasCasa: Estatisticas,estatisticasFora: Estatisticas, partida: Partidas) :
    ...
    headers = {"Content-Type": "application/json"}
    try:
        response = requests.put(url, json=EstatisticaPartida, headers=headers)
